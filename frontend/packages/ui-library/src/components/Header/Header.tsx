...
import { adhaBrand } from '@adha/ui-assets';
...
const defaultLogo = `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 560 96'%3E%3Crect width='560' height='96' fill='%23fff'/%3E%3Ctext x='24' y='58' font-family='Arial, sans-serif' font-size='34' font-weight='700' fill='%2300558c'%3EADHA%3C/text%3E%3Ctext x='132' y='58' font-family='Arial, sans-serif' font-size='24' fill='%23222'%3EAustralian Digital Health Agency%3C/text%3E%3C/svg%3E`;

export function Header({
  brandName,
  homeHref = '/',
  logoAlt = adhaBrand.markLabel,
  logoSrc = defaultLogo,
  searchAction = '/search',
  searchId = 'search-field',
  searchName = 'search',
  searchPlaceholder = 'Search this website',
  screenReaderBrand = adhaBrand.markLabel,
  subline,
  subNavLinks = [],
}: HeaderProps) {
  return (
